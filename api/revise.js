export default async function handler(req, res) {
  ...
  try {
    ...
    const PROMPTS = {
      ...
      P3: "Rewrite the email in a professional and appropriate tone for the workplace, focusing on formality and professionalism, while keeping the content unchanged.",
      P4: "Carefully review the email for potential errors or ambiguities and ensure clarity and correctness without adding information.",
      P5: "Rewrite the email so that it sounds confident and self-assured while keeping the factual content unchanged.",
      P6: "Rewrite the email to sound very polite and considerate in tone while keeping the content unchanged."
    };
